<?php
/**
 * agratitudesign telaga functions and definitions
 *
...
if ( ! function_exists( 'agratitudesign_setup' ) ) :
	...
	function agratitudesign_setup() {
		 ...
		 * If you're building a theme based on agratitudesign telaga, use a find and replace
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'agratitudesign' ),
		) );
...
function agratitudesign_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'agratitudesign' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'agratitudesign' ),
 ...
 */
require get_template_directory() . '/inc/extras/enqueue.php';
