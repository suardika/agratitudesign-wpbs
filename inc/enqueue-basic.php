...
function agratitudesign_scripts() {
    ...
    wp_enqueue_script( 'mixitup_js', get_template_directory_uri() . '/assets/js/mixitup.min.js', array(''), '', true );
    wp_enqueue_script( 'inview_js', get_template_directory_uri() . '/assets/js/inview.js', array(), '', true );
    wp_enqueue_script( 'counterup_js', get_template_directory_uri() . '/assets/js/jquery.counterup.min.js', array('jquery_js'), '', true );
